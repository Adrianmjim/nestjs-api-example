  ...
  describe('.updateOne()', () => {
    describe('when called', () => {
      ...
      beforeAll(async () => {
        ...
        entityRepositoryMock.find.mockResolvedValueOnce(modelTestFixtures as Loaded<ModelTest, string>[]);
    ...
    describe('when called and entityRepository.flush throws an Error matching PostgreSqlErrorType.FOREIGN_KEY_VIOLATION', () => {
      ...
      beforeAll(async () => {
        ...
        (
          isPostgreSqlErrorWithErrorType as unknown as jest.Mock<typeof isPostgreSqlErrorWithErrorType>
