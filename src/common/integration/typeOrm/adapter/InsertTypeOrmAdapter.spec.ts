  ...
  describe('.insertOne()', () => {
    describe('when called', () => {
      ...
      it('should call queryToTypeOrmQueryConverterMock.convert()', () => {
        expect(queryToTypeOrmQueryConverterMock.convert).toHaveBeenCalledTimes(1);
        expect(queryToTypeOrmQueryConverterMock.convert).toHaveBeenCalledWith(queryFixture);
      });
      ...
      it('should call modelDbToModelConverter.convert()', () => {
        ...
        expect(modelDbToModelConverterMock.convert).toHaveBeenCalledWith(modelFixture);
      });
