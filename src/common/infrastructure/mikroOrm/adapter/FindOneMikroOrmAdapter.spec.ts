...
describe(FindOneMikroOrmAdapter.name, () => {
  ...
  beforeAll(() => {
    ...
    findOneMikroOrmAdapter = new FindOneMikroOrmAdapter(
      entityRepositoryMock,
      queryTestToFindOneQueryMikroOrmConverterAsyncMock,
      queryTestToFindOneOptionsQueryMikroOrmConverterAsyncMock,
      modelDbToModelConverterAsyncMock,
  ...
  describe('.findOne()', () => {
    describe('when called and entityRepository.findOne() returns null', () => {
      ...
      beforeAll(async () => {
        ...
        (
          queryTestToFindOneQueryMikroOrmConverterAsyncMock.convert as jest.Mock<Promise<ObjectQuery<ModelTest>>>
        ).mockResolvedValueOnce(findOneQueryMikroOrmTestFixture);
        (
          queryTestToFindOneOptionsQueryMikroOrmConverterAsyncMock.convert as jest.Mock<
            Promise<FindOneOptions<ModelTest>>
          >
        ).mockResolvedValueOnce(findOneOptionsQueryMikroOrmTestFixture);
