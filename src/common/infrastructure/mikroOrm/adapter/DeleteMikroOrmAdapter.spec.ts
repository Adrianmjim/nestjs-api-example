...
describe(DeleteMikroOrmAdapter.name, () => {
  ...
  beforeAll(() => {
    ...
    deleteMikroOrmAdapter = new DeleteMikroOrmAdapter(
      entityRepositoryMock,
      commandTestToDeleteQueryMikroOrmConverterAsyncMock,
    );
  });
  ...
  describe('.delete', () => {
    describe('when called', () => {
      ...
      beforeAll(async () => {
        ...
        (
          commandTestToDeleteQueryMikroOrmConverterAsyncMock.convert as jest.Mock<Promise<ObjectQuery<ModelTest>>>
        ).mockResolvedValueOnce(deleteQueryMikroOrmTestFixture);
    ...
    describe('when called and entityRepository.nativeDelete throws an Error and isPostgreSqlErrorWithErrorType returns true', () => {
